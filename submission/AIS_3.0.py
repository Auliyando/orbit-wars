...
class KaggleAISBallisticSubmissionAgent:
    def __init__(self):
        ...
        self.W_NS = 0.35       # Garrison Penalty: How much the bot avoids heavily defended targets
        self.W_GR = 0.222      # Production Reward: How much the bot values permanent income
        self.W_DIS = 0.612     # Distance Penalty: How much the bot hates long travel times
        self.POOL_PERC = 0.952 # Attack Fleet Mass: Percentage of available ships sent out in an attack wave
