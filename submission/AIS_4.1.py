...
def check_planet_collision(sx, sy, tx, ty, obs, source_id, target_id):
    ...
    for p in normalized_planets:
        ...
        # Vector projection factor t clamped to the line segment
...
def calculate_exact_ballistic_angle(source_planet, target_planet, num_ships, game_angular_velocity, obs):
    ...
    if not is_comet and orbital_radius + t_radius >= 50.0:
        ...
        # --- NEW: Check planet obstacles for outer rim nodes ---
    ...
    # --- NEW: Check if future trajectory collides with any moving sister planet ---
...
class KaggleAISBallisticSubmissionAgent:
    def __init__(self):
        ...
        self.W_NS = 0.1087           # Garrison Penalty: How much the bot avoids heavily defended targets
        self.W_GR = 0.4476           # Production Reward: How much the bot values permanent income
        self.W_DIS = 1.7146          # Distance Penalty: How much the bot hates long travel times
        self.POOL_PERC = 0.4748
