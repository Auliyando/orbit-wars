...
class KaggleAISBallisticSubmissionAgent:
    def __init__(self):
        ...
        self.W_NS = 0.3047           # Garrison Penalty: How much the bot avoids heavily defended targets
        self.W_GR = 1.3961           # Production Reward: How much the bot values permanent income
        self.W_DIS = 1.4466          # Distance Penalty: How much the bot hates long travel times
        self.POOL_PERC = 0.4823      # Attack Fleet Mass: Percentage of available ships sent out in an attack wave
            ...
            for my_p in my_planets:
                if is_early_game:
                    ...
                    if angle is not None:
                        ...
                        # --- ENFORCED MINIMUM SIZE GUARD ---
                        # If target defense requirement drops below 5, pad it to 5 to prevent trickling
                        if final_needed < 5:
                            final_needed = 5
